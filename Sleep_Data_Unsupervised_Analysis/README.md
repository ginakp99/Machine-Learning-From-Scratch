...
> **Project Summary:** An exploratory analysis of the Sleep-EDF dataset using Unsupervised Learning. I applied **Principal Component Analysis (PCA)** to reduce feature dimensionality and **K-Means Clustering** to discover latent structures in the data without using labels.
...
* **90% Variance Threshold:** The analysis showed that only **5 components** are necessary to explain 90% of the total variance in the original 16-dimensional dataset. This suggests the data can be compressed significantly.
...
![Clustering Comparison: Random vs K-Means++ Initialization](clustering_comparison.png)
...
* **Statistical Insight:** Used the Eigenspectrum to justify data redundancy and show an understanding of variance and information preservation.
* **Algorithm Optimization:** Proved the practical value of **K-Means++** for ensuring stability and reliable convergence in iterative models.
